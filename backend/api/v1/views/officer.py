...
class OfficerRequestViewSet(viewsets.ModelViewSet):
    ...
    def assign_to_self(self, request, pk=None):
        ...
        try:
            ...
            if request_obj.assigned_to:
                return Response(
                    {'detail': 'Request is already assigned to an officer.'},
    ...
    def complete_request(self, request, pk=None):
        ...
        try:
            ...
            # Check if request is assigned to current officer
            try:
                officer = Officer.objects.get(user=request.user)
                if request_obj.assigned_to != officer:
                    return Response(
            ...
            # Process any documents if needed
...
class OfficerCitizenViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        """
        queryset = User.objects.filter(roles__name='citizen')
    ...
    def get_citizen_documents(self, request, pk=None):
        ...
        try:
            ...
            for doc in documents:
                ...
                creator_name = ''
                if doc.created_by:
                    creator_name = f"{doc.created_by.first_name} {doc.created_by.last_name}".strip() or doc.created_by.email
    ...
    def update_citizen(self, request, pk=None):
        ...
        try:
            ...
            # Cập nhật trạng thái xác thực CCCD nếu cần
            if 'verify_id_card' in request.data and request.data['verify_id_card'] is True:
    ...
    def get_document_detail(self, request, document_id=None):
        ...
        try:
            ...
            if document.created_by:
                creator_name = f"{document.created_by.first_name} {document.created_by.last_name}".strip() or document.created_by.email
