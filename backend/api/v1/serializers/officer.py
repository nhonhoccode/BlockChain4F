...
class OfficerRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Request
        fields = [
            'id', 'title', 'description', 'request_type', 'request_type_display',
            'status', 'status_display', 'priority', 'created_at', 'updated_at',
            'requestor', 'assigned_to', 'reject_reason', 'days_since_submission',
            'document_count'
        ]
    ...
    def get_request_type_display(self, obj):
        ...
        return request_types.get(obj.request_type, obj.request_type)
    ...
    def get_document_count(self, obj):
        ...
        return Document.objects.filter(request=obj).count()
