...
const CitizenRequests = lazy(() => import('../pages/citizen/Requests/RequestList'));
...
const CitizenDocuments = lazy(() => import('../pages/citizen/Documents/DocumentList'));
const CitizenDocumentDetail = lazy(() => import('../pages/citizen/Documents/DocumentDetail'));
...
const OfficerApprovalList = lazy(() => import('../pages/admin/chairman/OfficerManagement/OfficerApprovalList'));
